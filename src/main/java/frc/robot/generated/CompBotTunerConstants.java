...
public class CompBotTunerConstants {
    ...
    public static final CANBus kCANBus = new CANBus("MAELSTROM", "./logs/example.hoot");
     ...
     */
    public static class CompBotTunerSwerveDrivetrain extends SwerveDrivetrain<TalonFX, TalonFX, CANcoder> {
        /**
