...
object Robot : LoggedRobot() {
    ...
    init {
        ...
        manipulatorController.a().onTrue(SuperStructure.smartGoTo(RobotState.L1))
        ...
        joystick.button(9).whileTrue(Climber.reverseRoller)
        joystick.button(10).whileTrue(Climber.runRoller)
