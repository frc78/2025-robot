...
object Alignments {
    ...
    private val REEF_TO_BOT_TRANSFORM = Transform2d(0.0.meters, 0.meters, Rotation2d.kZero)
    private val CORAL_TO_BOT_TRANSFORM = Transform2d(0.0.meters, 0.meters, Rotation2d.k180deg)
